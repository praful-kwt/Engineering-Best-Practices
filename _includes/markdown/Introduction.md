...
The KrishaWeb Engineering Best Practices are not geared to teach anyone to become an engineer. Rather, they aim to illustrate how to engineer the KrishaWeb way. Therefore, these best practices are intended for capable engineers.
...
As such, KrishaWeb engineers should follow these best practices in all their work. Our best practices are not meant to be restrictive or comprehensive; we value creativity at KrishaWeb. The aim is for this document to provide a strong guidance, not an authoritative direction. It's our hope that these best practices will not only influence KrishaWebpers but community members as well.
...
At the very heart of KrishaWeb is the publishing or user experience. WordPress, we firmly believe, is the best starting point to achieve this. We design and build custom publishing experiences for major companies and brands around the world. Our publishing experiences or websites are tailor-made for our clients and their specific needs.
...
Please contribute via [pull requests on GitHub](https://github.com/KrishaWeb/Engineering-Best-Practices).
