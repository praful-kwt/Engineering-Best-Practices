...
Always enforce strong passwords. By default WordPress does not enforce strong passwords. Make sure to use a plugin or custom solution to enforce a strong password policy. KrishaWeb recommends using randomly generated passwords from a password manager application.
...
## KrishaWeb Experience Plugin

For improved security, KrishaWeb recommends our [KrishaWeb experience plugin](https://github.com/KrishaWeb/KrishaWeb-experience). KrishaWeb experience configures WordPress to better protect and inform our clients. [Please read the plugin readme for a description of the functionality.](https://github.com/KrishaWeb/KrishaWeb-experience#functionality)
